...
TASKS = [dict(num_class=6, class_names=['car', 'bicycle', 'pedestrian', 'bus', 'tricycle', 'truck'])]
...
class BEVHeightLightningModel(LightningModule):
    ...
    def __init__(self,
                 ...
                 default_root_dir='user_data/test_outputs',
                 **kwargs):
        super().__init__()
    ...
    def train_dataloader(self):
        train_dataset = NuscMVDetDataset(
            ...
            info_path="./user_data/data_info/school_infos_train.pkl",
            is_train=True,
    ...
    def val_dataloader(self):
        val_dataset = NuscMVDetDataset(
            ...
            classes=self.class_names,
            data_root=self.data_root,
            info_path="./user_data/data_info/school_infos_test.pkl",
            is_train=False,
            img_conf=self.img_conf,
            num_sweeps=self.num_sweeps,
            sweep_idxes=self.sweep_idxes,
...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./user_data/test_outputs/bev_height_lss_r101_864_1536_256x256/checkpoints', filename='{epoch}', every_n_epochs=3, save_last=True, save_top_k=-1)
    ...
    if args.evaluate:
        ...
        backup_codebase(os.path.join('./user_data/test_outputs/bev_height_lss_r101_864_1536_256x256', 'backup'))
        trainer.fit(model)
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./user_data/test_outputs/bev_height_lss_r101_864_1536_256x256')
