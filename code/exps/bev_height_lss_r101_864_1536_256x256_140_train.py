...
data_root = "./xfdata/train/"
# gt_label_path = "data/mono_school-kitti/training/label_2"
...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./user_data/train_outputs/bev_height_lss_r101_864_1536_256x256/checkpoints', filename='{epoch}', every_n_epochs=3, save_last=True, save_top_k=-1)
    ...
    if args.evaluate:
        ...
        backup_codebase(os.path.join('./user_data/train_outputs/bev_height_lss_r101_864_1536_256x256', 'backup'))
        trainer.fit(model)
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./user_data/train_outputs/bev_height_lss_r101_864_1536_256x256')
